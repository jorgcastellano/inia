	  ...
	  <form method="POST" action="index">
			...
			switch ($opc) {
			  ...
			  case 2:
				  ...
				  while ($resultado = $result->fetch_array()) 
				  {
					...
					echo "<td>".$resultado[2]." ".$unidad."</td>";
					echo "<td>".$resultado[3]." Bs"."</td>";
					echo "<td><input type='checkbox' name='seleccion[]' title='Selecciona para modificar o eliminar este análisis' value='$resultado[0]'></td></tr>";
				  }
				  echo "</table>";
				}
		?>
		<div class="grupobotones">
			 ...
			 <button type="submit" class="boton" name="modificar" value="modificar"><i class="fa fa-pencil"></i> Modificar Producto</button>
			   <button type="submit" class="boton" name="eliminar" value="eliminar" formaction="inve" ><i class='fa fa-trash-o'></i> Eliminar Producto</button>
